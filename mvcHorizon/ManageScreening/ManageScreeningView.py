...
class ManageScreeningView(Frame):
    ...
    def add_new_shows(self):
        ...
        title = Label(self.newShows,text="Add New Shows",font=14).pack(**self.padding)

        #date
        dateCreateShowLabel = Label(self.newShows, text='Choose Date', font=12).pack(**self.padding, fill=X)
        self.dateCreateShow = DateEntry(self.newShows)
        self.dateCreateShow.pack(**self.padding, fill=X)

        #time
        timeCreateShowLabel = Label(self.newShows, text='Choose Time', font=12).pack(**self.padding, fill=X)
        ...
        filmCreateShowLabel = Label(self.newShows, text='Choose Film', font=12).pack(**self.padding, fill=X)
        ...
        cinemaCreateShowLabel = Label(self.newShows, text='Choose Cinema', font=12).pack(**self.padding, fill=X)
        ...
        screenCreateShowLabel = Label(self.newShows, text='Choose Screen', font=12).pack(**self.padding, fill=X)
        columns = ('screenid')
